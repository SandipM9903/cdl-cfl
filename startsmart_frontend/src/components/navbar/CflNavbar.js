...
const CflNavbar = ({ activeTab, onTabChange }) => {
  const menuItems = [
    { id: 'overview', label: 'Dashboard', icon: FaHome, iconColor: '#FFA726' },
    { id: 'profile', label: 'My Profile', icon: FaUser, iconColor: '#26A69A' },
    { id: 'upload-files', label: 'My Files', icon: FaFolderOpen, iconColor: '#66BB6A' },
    { id: 'performance', label: 'Performance', icon: FaBullseye, iconColor: '#26C6DA' },
    { id: 'mentoring', label: 'Mentoring', icon: FaHeart, iconColor: '#EC407A' },
    { id: 'skills', label: 'Skills', icon: FaStar, iconColor: '#F3C63F' },
    { id: 'meetings', label: 'Meetings', icon: FaCalendarAlt, iconColor: '#AB47BC' },
    { id: 'memories', label: 'Memories', icon: FaCamera, iconColor: '#5C6BC0' },
  ];
